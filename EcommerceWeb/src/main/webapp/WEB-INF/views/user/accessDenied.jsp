...
<head>
    ...
    <link rel="stylesheet" href="/ecommerce/user/css/accessDenied.css">
</head>
<body>
...
<p id="text">Bạn không có quyền truy cập vào trang!</p>
<p id="credit">Created with the help of <a href="http://dynamicsjs.com/">Dynamics.js</a></p>

<script src="/ecommerce/user/js/accessDenied.js"></script>
</body>
</html>